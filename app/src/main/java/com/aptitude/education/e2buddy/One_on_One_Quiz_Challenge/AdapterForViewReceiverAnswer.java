...
public class AdapterForViewReceiverAnswer extends RecyclerView.Adapter<AdapterForViewReceiverAnswer.AnswerHolder> {
    Context mCtx;
   List<AnswerViewForOneOnOne> list;
    ...
    public AdapterForViewReceiverAnswer(Context mCtx, List<AnswerViewForOneOnOne> list) {
        this.mCtx = mCtx;
        this.list = list;
    }
