...
public class InsertScoreData {

    int final_score;
    int tournament_point_spent;
    int daily_quiz_total_score;
    int tournament_point_earn;
    int category_total_score;

    public InsertScoreData(int final_score, int tournament_point_spent, int daily_quiz_total_score, int tournament_point_earn, int category_total_score) {
    ...
    public int getTournament_point_earn() {
        return tournament_point_earn;
    }

    public void setTournament_point_earn(int tournament_point_earn) {
        this.tournament_point_earn = tournament_point_earn;
    }
}
