...
public class AdapterForQuizCategoryQuestion extends PagerAdapter {

    private List<QuestionView> questionViewList;
    Context context;
    LayoutInflater layoutInflater;
    String userid,quizdate,value, parent_category, child_category;
    ...
    public AdapterForQuizCategoryQuestion(List<QuestionView> questionViewList, Context context, String userid, String parent_category, String child_category, int quiz_id) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("category_user_answer");
    ...
    private void insertAnswer(String questionid, String answer){
        ...
        databaseReference.child(userid).child(parent_category).child(child_category).child(String.valueOf(quiz_id)).child(questionid).setValue(answers);
