...
public class TournamentQuizAdapter extends PagerAdapter {

    private List<QuestionView> questionViewList;
    Context context;
    LayoutInflater layoutInflater;
    String userid,tournament_quiz_id;
    DatabaseReference databaseReference;
    Button btn_unfocus;

    public String[] qnum = {"1/10","2/10","3/10","4/10","5/10","6/10","7/10","8/10","9/10","10/10"};

    public TournamentQuizAdapter(List<QuestionView> questionViewList, Context context, String userid, String tournament_quiz_id) {
        this.questionViewList = questionViewList;
        this.context = context;
        this.userid = userid;
        this.tournament_quiz_id = tournament_quiz_id;
    }
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("tournament_user_answer");
    ...
    private void insertAnswer(String questionid, String answer){
        ...
        databaseReference.child(userid).child(tournament_quiz_id).child(questionid).setValue(answers);
